...
**Severity:** Critical
**Component:** history
**Dashboard panel:** [Dead-Lettered Tasks — Execution-Stranding](https://github.com/tsurdilo/temporal-metrics/blob/main/observability/dashboards/server/temporal-server-readme.md) — panel ID 2202 (History Task DLQ / Terminal Failures group)
