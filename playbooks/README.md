...
| [Dual Visibility](./dual-visibility.md) | Running two visibility stores — which one is failing and how to tell, the ~70-minute clock before visibility records are dropped, primary / secondary / both-stores-down scenarios, and moving reads and writes between stores for a failover or a migration. Both stores on SQL (PostgreSQL / MySQL) or both on Elasticsearch. | [Temporal Server](../observability/dashboards/server/temporal-server-readme.md#16-visibility) v2.15.0+ | 059a, 059b, 059c, 083, 084, 085 |
