...
**Severity:** Critical
**Component:** history
**Dashboard panel:** [Owned Shards (Total)](https://github.com/tsurdilo/temporal-metrics/blob/main/metrics/dashboards/server/temporal-server-readme.md) — panel ID 2120, Shard Movement group
