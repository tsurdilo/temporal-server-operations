...
**Alert:** [FAILOVER-PRE-01](../../../metrics/alerts/server/alerts-index.md#alert-failover-pre-01--replication-stream-stuck-pre-handover) — fires after 2 minutes sustained, severity critical.
...
**Alert:** [FAILOVER-PRE-02](../../../metrics/alerts/server/alerts-index.md#alert-failover-pre-02--replication-dlq-enqueue-failing) — fires after 2 minutes sustained, severity critical.
...
**Alerts:** [FAILOVER-PRE-05](../../../metrics/alerts/server/alerts-index.md#alert-failover-pre-05--receiver-backlog-near-limit) (≥ 400, warning) · [FAILOVER-PRE-04](../../../metrics/alerts/server/alerts-index.md#alert-failover-pre-04--receiver-backlog-at-flow-control-limit) (≥ 500, critical).
...
**Alert:** [FAILOVER-PRE-03](../../../metrics/alerts/server/alerts-index.md#alert-failover-pre-03--replication-stream-errors-sustained) — fires after 2 minutes sustained, severity critical.
...
**Alert:** [FAILOVER-PRE-06](../../../metrics/alerts/server/alerts-index.md#alert-failover-pre-06--standby-task-discards-detected) — fires after 2 minutes sustained, severity warning.
...
**Alert:** [FAILOVER-HANDOVER-01](../../../metrics/alerts/server/alerts-index.md#alert-failover-handover-01--handover-drain-stalled) — fires after 20s stalled, severity critical.
...
**Alert:** [FAILOVER-HANDOVER-01](../../../metrics/alerts/server/alerts-index.md#alert-failover-handover-01--handover-drain-stalled) — if this burst does not clear within the drain window, drain has stalled.
...
**Alert:** [FAILOVER-POST-03](../../../metrics/alerts/server/alerts-index.md#alert-failover-post-03--version-mismatch-not-decaying) — fires if rate does not decay within 5 minutes, severity warning. 📋 Planned — not yet provisioned in `temporal-failover-alerts.yaml`.
...
**Alert:** [FAILOVER-POST-01](../../../metrics/alerts/server/alerts-index.md#alert-failover-post-01--forwarding-failedprecondition-errors) — fires on sustained `FailedPrecondition` errors after 2 minutes, severity warning.
...
**Alert:** [FAILOVER-POST-02](../../../metrics/alerts/server/alerts-index.md#alert-failover-post-02--wft-schedule-to-start-elevated-post-flip) — fires if p99 > 5s more than 3 minutes after the flip, severity warning. 📋 Planned — not yet provisioned in `temporal-failover-alerts.yaml`.
